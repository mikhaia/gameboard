...
# <img src="https://fonts.gstatic.com/s/i/materialiconsoutlined/inventory_2/v1/24px.svg" alt="inventory icon" width="24" height="24" style="vertical-align:middle"> What's in the box?
- Laravel 10
- Inertia 1
- Tailwind
- Vite 3
...
# <img src="https://fonts.gstatic.com/s/i/materialiconsoutlined/rocket_launch/v1/24px.svg" alt="rocket launch icon" width="24" height="24" style="vertical-align:middle"> Start
